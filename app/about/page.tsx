            ...
            <div className="flex flex-col sm:flex-row gap-6 p-6 rounded-2xl border border-gray-100 shadow-sm">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm leading-relaxed">
                  20 років, студентка КПІ та людина, яка на власному досвіді
                  переконалась у силі міжнародних можливостей. 9 обмінів,
                  семестр у Хорватії та незабаром Франція — саме цей шлях
                  надихнув створити Моживо.
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 p-8 flex flex-col gap-4">
              ...
              <p className="text-gray-700 text-base italic leading-relaxed -mt-4">
                ...
                свою першу можливість. Щоб не гуглити годинами, не питати в
                десяти чатах — а просто відкрити і знайти.
              </p>
