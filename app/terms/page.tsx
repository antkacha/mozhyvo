      ...
      <div className="prose prose-sm max-w-none space-y-8 text-foreground">
        <section>
          ...
          <p className="text-muted leading-relaxed">
            Реєструючись або використовуючи платформу Моживо (<strong>mozhyvo.com.ua</strong>), ви погоджуєтесь дотримуватись цих Умов використання. Якщо ви не погоджуєтесь, будь ласка, не використовуйте платформу.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted leading-relaxed">
            Моживо — це безкоштовна інформаційна платформа, яка агрегує міжнародні можливості (стипендії, стажування, волонтерство, обміни) та дозволяє організаціям публікувати свої програми. Моживо не є роботодавцем, організатором програм або грантодавцем і не несе відповідальності за рішення, прийняті організаціями щодо заявників.
          </p>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc pl-5 space-y-2 text-muted leading-relaxed">
            ...
            <li>Моживо залишає за собою право видалити будь-яку публікацію без пояснень.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="text-muted leading-relaxed">
            Моживо надає платформу «як є» і не гарантує точність інформації, опублікованої організаціями. Ми не несемо відповідальності за будь-які збитки, що виникли внаслідок використання платформи або результатів розгляду заявок.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted leading-relaxed">
            Весь контент платформи (дизайн, тексти, логотипи) є власністю Моживо. Контент організацій та користувачів залишається їхньою власністю — розміщуючи його, вони надають Моживо невиключну ліцензію на відображення.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="text-muted leading-relaxed">
            Питання щодо умов: <a href="mailto:mozhyvo@gmail.com" className="text-primary hover:underline">mozhyvo@gmail.com</a>
          </p>
        </section>
      </div>
